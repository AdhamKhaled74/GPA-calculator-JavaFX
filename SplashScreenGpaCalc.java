...
public class SplashScreenGpaCalc extends Application {
    ...
    public void start(Stage primaryStage) {
        ...
        Label progressLabel = new Label("Going to GPA page... 0%");
    ...
    private void simulateLoading(Label progressLabel, Stage primaryStage) {
        Thread loadingThread = new Thread(() -> {
            ...
            while (completedTasks < TOTAL_TASKS) {
                ...
                updateLabel(progressLabel, "Loading GPA Page.." + String.format("%.0f%%", progress));
    ...
    private void closeSplashScreen(Window window) {
        ...
        Platform.runLater(() -> {
            window.hide();
            GpaCalculator gpapage = new GpaCalculator(); // Replace with your LoginScreen class
            Stage loginStage = new Stage();
            gpapage.start(loginStage);
