...
public class SplashScreenStudentDetails extends Application {
    ...
    private void closeSplashScreen(Window window) {
        ...
        Platform.runLater(() -> {
            window.hide();
            StudentPage studentPage = new StudentPage(); // Replace with your LoginScreen class
            Stage loginStage = new Stage();
            studentPage.start(loginStage);
